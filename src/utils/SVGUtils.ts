...
export function makeTransferSVG(
    width: number,
    height: number,
    dy: number,
    sourceCount: number,
    ...
    let result =
        "<svg style='width: 100%; height: 100%; position: absolute; left:0; top:0' viewBox='0 0 " +
        width +
        " " +
        height +
        "'>\n";
...
export function makeTransferPathZ(
    width: number,
    height: number,
    dy: number,
    sourceCount: number,
