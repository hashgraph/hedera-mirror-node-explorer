...
export class StakingPeriod {
    ...
    public constructor(
        startTimeInSec: number | null = null,
        endTimeInSec: number | null = null,
    ) {
        ...
        this.elapsedMin = Math.floor(
            (this.currentDate.getTime() - this.startTime) / 1000 / 60,
        );
        this.remainingMin = Math.ceil(
            (this.endTime - this.currentDate.getTime()) / 1000 / 60,
        );
    }
}
