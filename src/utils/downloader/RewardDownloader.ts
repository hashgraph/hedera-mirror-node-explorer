...
export class RewardDownloader extends EntityDownloader<
    StakingReward,
...
> {
    ...
    protected makeCSVEncoder(
        dateFormat: Intl.DateTimeFormat,
    ): CSVEncoder<StakingReward> {
        return new RewardEncoder(
            this.getEntities(),
            this.checkAccountId(),
            dateFormat,
        );
