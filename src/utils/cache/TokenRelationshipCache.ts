...
export class TokenRelationshipCache extends EntityCache<
    string,
    TokenRelationship[] | null
> {
    ...
    protected async load(
        ...
        while (url !== null && counter > 0) {
            const response: AxiosResponse<TokenRelationshipResponse> =
                await axios.get<TokenRelationshipResponse>(url);
