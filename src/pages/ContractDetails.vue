        ...
        <DashboardCard>
            ...
            <template v-slot:leftContent>
                <Property id="balance">
                    ...
                    <template v-slot:value>
                        <div class="has-flex-direction-column">
                            <HbarAmount v-if="contract" :amount="balance ?? undefined" :show-extra="true"
                                        timestamp="0"/>
                            ...
                            <div v-else>
                                <div v-for="t in tokens ?? []" :key="t.token_id">
                                    <TokenAmount :amount="BigInt(t.balance)" :show-extra="true"
                                                 :token-id="t.token_id ?? undefined"/>
                                </div>
                            </div>
                        </div>
                    </template>
                ...
                <Property id="key">
                    ...
                    <template v-slot:value>
                        <KeyValue :key-bytes="contract?.admin_key?.key" :key-type="contract?.admin_key?._type"
                                  :show-none="true"/>
                    </template>
                </Property>
                <Property id="memo">
                ...
                <Property id="expiresAt">
                    ...
                    <template v-slot:value>
                        <TimestampValue v-bind:timestamp="contract?.expiration_timestamp ?? undefined"
