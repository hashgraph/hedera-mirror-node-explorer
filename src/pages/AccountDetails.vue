        ...
        <DashboardCard>
                        ...
                        <Property id="balance">
                            ...
                            <template v-slot:value>
                                <div v-if="account" class="h-is-tertiary-text">
                                    <HbarAmount v-bind:amount="hbarBalance ?? undefined" v-bind:show-extra="true"
                                                timestamp="0"/>
                                </div>
                                ...
                                <div v-else>
                                    <div v-for="b in tokenBalances ?? []" :key="b.token_id" class="h-is-tertiary-text">
                                        <TokenAmount v-bind:amount="BigInt(b.balance)" v-bind:show-extra="true"
                                                     v-bind:token-id="b.token_id ?? undefined"/>
                                    </div>
                                </div>
                                <div v-if="elapsed && !isSmallScreen" class="has-text-grey has-text-right"> {{
                                    elapsed
                                    }} ago
                                </div>
                            </template>
            ...
            <template v-slot:leftContent>
                ...
                <Property id="memo">
                    ...
                    <template v-slot:value>
                        <BlobValue v-bind:base64="true" v-bind:blob-value="account?.memo ?? undefined"
                ...
                <Property id="expiresAt">
                    ...
                    <template v-slot:value>
                        <TimestampValue v-bind:show-none="true"
                                        v-bind:timestamp="account?.expiry_timestamp ?? undefined"/>
                    </template>
                </Property>
