        ...
        <DashboardCard>
            <template v-if="!isInactiveEvmAddress" v-slot:title>
                ...
                <div class="h-is-tertiary-text mt-3" id="entityId">
                    <div
                        class="is-inline-block h-is-property-text has-text-weight-light"
                ...
                <div
                    v-if="operatorNodeRoute"
                    id="nodeLink"
                    class="h-is-tertiary-text mt-2"
                >
                    <div
                        class="is-inline-block h-is-property-text has-text-weight-light"
                        style="min-width: 115px"
                ...
                <div
                    v-if="
                        !isMediumScreen && showContractVisible && contractRoute
                    "
                    id="showContractLink"
            ...
            <template v-else v-slot:title>
                ...
                <div
                    v-if="!isMediumScreen && showContractVisible"
                    id="showContractLink"
                    class="is-inline-block mt-2"
                >
                    <router-link :to="contractRoute">
            ...
            <template v-slot:content>
                ...
                <div class="columns h-is-property-text">
                    <div class="column">
                        <Property id="balance">
                            <template v-slot:name>{{
                                tokenBalances?.length ? "Balances" : "Balance"
                            }}</template>
                            <template v-slot:value>
                                <div v-if="account" class="h-is-tertiary-text">
                                    <HbarAmount
                                        v-bind:amount="hbarBalance"
                                        v-bind:show-extra="true"
                                        timestamp="0"
                                    />
                                </div>
                                <div
                                    v-else-if="isInactiveEvmAddress"
                                    class="h-is-tertiary-text"
                                >
                                    <HbarAmount
                                        v-bind:amount="0"
                                        v-bind:show-extra="true"
                                ...
                                <div v-else>
                                    <div
                                        ...
                                        :key="b.token_id ?? undefined"
                                        class="h-is-tertiary-text"
                                    >
                                        <TokenAmount
                                            v-bind:amount="BigInt(b.balance)"
                                            v-bind:show-extra="true"
                                            v-bind:token-id="b.token_id"
                                        />
                                    </div>
                                </div>
                                <div
                                    v-if="elapsed && !isSmallScreen"
                    ...
                    <div class="column">
                        <div
                            v-if="isSmallScreen && elapsed"
                            class="has-text-right has-text-grey mt-1"
                        >
                            {{ elapsed }} ago
                        </div>
                    </div>
            ...
            <template v-slot:leftContent>
                <Property id="stakedTo">
                    ...
                    <template v-slot:value>
                        <div v-if="stakedAccountId">
                            ...
                            <div class="is-inline-block">
                                <AccountLink
                                    :accountId="account?.staked_account_id"
                                    v-bind:show-extra="true"
                                />
                            </div>
                        </div>
                ...
                <Property id="pendingReward">
                    ...
                    <template v-slot:value>
                        <HbarAmount
                            :amount="account?.pending_reward"
                            :show-extra="true"
                            timestamp="0"
                        />
                        <div
                            v-if="stakePeriodStart"
                ...
                <Property
                    v-if="account?.staked_node_id != null"
                    id="declineReward"
                >
                ...
                <Property id="memo">
                    ...
                    <template v-slot:value>
                        <BlobValue
                            v-bind:base64="true"
                            v-bind:blob-value="account?.memo"
                ...
                <Property id="createTransaction">
                    ...
                    <template v-slot:value>
                        <TransactionLink
                            :transactionLoc="
                                account?.created_timestamp ?? undefined
                            "
                        />
                    </template>
                </Property>
                ...
                <Property id="expiresAt">
                    <template v-slot:name>
                        ...
                        <InfoTooltip
                            label="Account expiry is not turned on yet. Value in this field is not relevant."
                        />
                    </template>
                    <template v-slot:value>
                        <TimestampValue
                            v-bind:show-none="true"
                            v-bind:timestamp="account?.expiry_timestamp"
                        />
                    </template>
                </Property>
                <Property id="autoRenewPeriod">
                    <template v-slot:name>
                        ...
                        <InfoTooltip
                            label="Account auto-renew is not turned on yet. Value in this field is not relevant."
                        />
                    </template>
                    <template v-slot:value>
                        <DurationValue
                            v-bind:number-value="
                                account?.auto_renew_period ?? undefined
                            "
                        />
                    </template>
                </Property>
                <Property id="maxAutoAssociation">
                    ...
                    <template v-slot:value>
                        <StringValue
                            :string-value="
                                account?.max_automatic_token_associations?.toString()
                            "
                        />
                    </template>
                </Property>
                <Property id="receiverSigRequired">
                    ...
                    <template v-slot:value>
                        <StringValue
                            :string-value="
                                account?.receiver_sig_required?.toString()
                            "
                        />
                    </template>
                </Property>
            ...
            <template v-slot:rightContent>
                <Property id="key">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :account-id="normalizedAccountId ?? undefined"
                            :key-bytes="account?.key?.key"
                ...
                <Property id="ethereumNonce">
                    ...
                    <template v-slot:value>
                        <StringValue
                            :string-value="account?.ethereum_nonce?.toString()"
                        />
                    </template>
                </Property>
            </template>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const accountLocParser = new AccountLocParser(
            computed(() => props.accountId ?? null),
        );
     ...
     */
        ...
        const elapsed = computed(() => {
            ...
            if (balanceAnalyzer.balanceTimeStamp.value) {
                const duration = Duration.decompose(
                    new Date().getTime() / 1000 -
                        Number.parseFloat(
                            balanceAnalyzer.balanceTimeStamp.value,
                        ),
                );
        ...
        // contract
        //
        const contractLookup = ContractByIdCache.instance.makeLookup(
            accountLocParser.accountId,
        );
        ...
        const stakedNodeIcon = computed(() => {
            ...
            if (accountLocParser.stakedNodeId.value !== null) {
                result = stakedNodeAnalyzer.isCouncilNode.value
                    ? "fas fa-building"
                    : "fas fa-users";
            } else {
                result = "";
        ...
        const contractRoute = computed(() => {
            ...
            return accountId
                ? routeManager.makeRouteToContract(accountId)
                : null;
        });

        const stakedNodeRoute = computed(() => {
            const stakedNodeId = accountLocParser.stakedNodeId.value;
            return stakedNodeId !== null
                ? routeManager.makeRouteToNode(stakedNodeId)
                : null;
        });

        const operatorNodeRoute = computed(() => {
            const operatorNodeId = accountLocParser.nodeId.value;
            return operatorNodeId != null
                ? routeManager.makeRouteToNode(operatorNodeId)
                : null;
        });
