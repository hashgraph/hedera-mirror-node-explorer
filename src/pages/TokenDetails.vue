    ...
    <DashboardCardV2 collapsible-key="tokenDetails">
      ...
      <template #left-content>
        ...
        <Property id="createTransaction">
          ...
          <template #value>
            <TransactionLink :transaction-loc="tokenInfo?.created_timestamp ?? undefined" />
          </template>
        </Property>
        <Property
          id="expiresAt"
          tooltip="Token expiry is not turned on yet. Value in this field is not relevant."
        >
          <template #name>
      ...
      <template #right-content>
        ...
        <Property id="initialSupply">
          ...
          >
            <TokenAmount
              :amount="parseBigIntString(tokenInfo?.initial_supply)"
              :show-extra="false"
              :token-id="normalizedTokenId"
            />
          </template>
