...
<template>
    ...
    >
        <DashboardCard>
            <template v-slot:title>
                ...
                <div
                    ...
                    id="evmAddress"
                    class="headline-grid is-align-items-baseline h-is-property-text mt-2"
                ...
                <div
                    v-if="ethereumAddress && !isSmallScreen"
                    class="mt-2 h-is-property-text"
                >
                    <MetaMaskImport
                        :address="ethereumAddress"
                        :decimals="tokenInfo?.decimals"
            ...
            <template v-slot:leftContent>
                <Property id="name">
                    ...
                    <template v-slot:value>
                        <BlobValue
                            v-bind:blob-value="tokenInfo?.name"
                ...
                <Property id="symbol">
                    ...
                    <template v-slot:value>
                        <BlobValue
                            v-bind:blob-value="tokenInfo?.symbol"
                            v-bind:show-none="true"
                        />
                    </template>
                </Property>
                ...
                <Property id="expiresAt">
                    <template v-slot:name>
                        ...
                        <InfoTooltip
                            label="Token expiry is not turned on yet. Value in this field is not relevant."
                        />
                    </template>
                    <template v-slot:value>
                        <TimestampValue
                            :nano="true"
                            :show-none="true"
                            :timestamp="tokenInfo?.expiry_timestamp?.toString()"
                        />
                    </template>
                </Property>
                <Property id="autoRenewPeriod">
                    <template v-slot:name>
                        ...
                        <InfoTooltip
                            label="Token auto-renew is not turned on yet. Value in this field is not relevant."
                        />
                    </template>
                    <template v-slot:value>
                        <DurationValue
                            v-bind:number-value="
                                tokenInfo?.auto_renew_period ?? undefined
                            "
                        />
                    </template>
                </Property>
                <Property id="autoRenewAccount">
                    ...
                    <template v-slot:value>
                        <AccountLink
                            :account-id="tokenInfo?.auto_renew_account"
                            :show-none="true"
                        />
                    </template>
                </Property>
                <Property id="freezeDefault">
                    ...
                    <template v-slot:value>
                        <StringValue
                            :string-value="
                                tokenInfo?.freeze_default?.toString()
                            "
                        />
                    </template>
                </Property>
                <Property id="pauseStatus">
                    ...
                    <template v-slot:value>
                        <StringValue
                            v-if="tokenInfo?.pause_status === 'NOT_APPLICABLE'"
                            class="has-text-grey"
                            string-value="Not applicable"
                        />
                        <StringValue
                            v-else
                            :string-value="tokenInfo?.pause_status"
                        />
                    </template>
                </Property>
            </template>
            ...
            <template v-slot:rightContent>
                <Property id="treasuryAccount">
                    ...
                    <template v-slot:value>
                        <AccountLink
                            :account-id="tokenInfo?.treasury_account_id"
                        />
                    </template>
                </Property>
                ...
                <Property id="totalSupply">
                    ...
                    <template v-if="validEntityId" v-slot:value>
                        <TokenAmount
                            :amount="parseBigIntString(tokenInfo?.total_supply)"
                            :show-extra="false"
                ...
                <Property id="initialSupply">
                    ...
                    <template v-if="validEntityId" v-slot:value>
                        <TokenAmount
                            :amount="
                                parseBigIntString(tokenInfo?.initial_supply)
                            "
                            :show-extra="false"
                            :token-id="normalizedTokenId"
                        />
                ...
                <Property id="maxSupply">
                    ...
                    <template v-if="validEntityId" v-slot:value>
                        <div
                            v-if="tokenInfo?.supply_type === 'INFINITE'"
                            class="has-text-grey"
                            >Infinite</div
                        >
                        <TokenAmount
                            v-else
                            :amount="parseBigIntString(tokenInfo?.max_supply)"
                            :show-extra="false"
                            :token-id="normalizedTokenId"
                        />
                    </template>
        ...
        <DashboardCard v-if="tokenInfo">
            ...
            <template v-slot:leftContent>
                <Property id="adminKey">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :key-bytes="tokenInfo?.admin_key?.key"
                ...
                <Property id="kycKey">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :key-bytes="tokenInfo?.kyc_key?.key"
                ...
                <Property id="freezeKey">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :key-bytes="tokenInfo?.freeze_key?.key"
                ...
                <Property id="wipeKey">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :key-bytes="tokenInfo?.wipe_key?.key"
            ...
            <template v-slot:rightContent>
                <Property id="supplyKey">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :key-bytes="tokenInfo?.supply_key?.key"
                ...
                <Property id="feeScheduleKey">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :key-bytes="tokenInfo?.fee_schedule_key?.key"
                ...
                <Property id="pauseKey">
                    ...
                    <template v-slot:value>
                        <KeyValue
                            :key-bytes="tokenInfo?.pause_key?.key"
        ...
        <DashboardCard v-if="tokenInfo">
            <template v-slot:title>
                <div
                    v-if="tokenInfo.type === 'NON_FUNGIBLE_UNIQUE'"
                    class="h-is-secondary-title mb-2"
                    >NFT Holders</div
                >
            ...
            <template v-slot:control>
                <PlayPauseButton
                    v-if="isNft"
                    :controller="nftHolderTableController"
                />
                <PlayPauseButton
                    v-else
                    :controller="tokenBalanceTableController"
                />
            </template>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const tokenLookup =
            TokenInfoCache.instance.makeLookup(normalizedTokenId);
        ...
        const displaySymbol = computed(() =>
            makeTokenSymbol(tokenLookup.entity.value, 256),
        );
        ...
        //
        const fungibleTokenId = computed(() =>
            tokenAnalyzer.isFungible.value ? normalizedTokenId.value : null,
        );
        const tokenBalanceTableController = new TokenBalanceTableController(
            useRouter(),
            fungibleTokenId,
            perPage,
        );
        ...
        //
        const nftTokenId = computed(() =>
            tokenAnalyzer.isNft.value ? normalizedTokenId.value : null,
        );
        const nftHolderTableController = new NftHolderTableController(
            useRouter(),
            nftTokenId,
            perPage,
        );
