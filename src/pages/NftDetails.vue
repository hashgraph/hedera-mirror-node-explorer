...
<template>
  <PageFrameV2 page-title="NFT Details">
    ...
    <DashboardCardV2 collapsible-key="nftDetails">
      ...
      <template #media-description>
        <Property
          v-if="name"
          id="name"
          custom-nb-col-class="is-one-quarter"
        >
          <template #name>
            Name
          </template>
        ...
        >
          ...
          <template #value>
            <TransactionLink :transaction-loc="nftInfo?.created_timestamp ?? undefined" />
          </template>
        </Property>
      </template>
    </DashboardCardV2>
    ...
    <DashboardCardV2
      ...
      collapsible-key="recentNftTransactions"
    >
      <template #title>
        Recent Transactions
      </template>
      ...
      <template #right-control>
        <TransactionFilterSelect
          v-model:selected-filter="transactionType"
          nft-filter
        />
      </template>
    ...
    <MirrorLink
      ...
      entity-url="tokens"
      :loc="normalizedTokenId + '/nfts/' + serialNumber"
    />
  </PageFrameV2>
</template>
