    ...
    <section :class="{'h-mobile-background': isTouchDevice || !isSmallScreen}" class="section">
        ...
        <DashboardCard>
            ...
            <template v-slot:rightContent>
                ...
                <NetworkDashboardItem id="minStake" :value="makeFloorHbarAmount(minStake)" name="HBAR"
                                      title="Min Stake"/>
                <br/><br/>
                <NetworkDashboardItem id="maxStake" :value="makeFloorHbarAmount(maxStake)" name="HBAR"
                                      title="Max Stake"/>
                <br/><br/>
                <NetworkDashboardItem id="rewarded" :value="makeFloorHbarAmount(stakeRewarded)" name="HBAR"
                                      title="Staked for Reward"/>
                <p id="rewardedPercent" class="h-is-property-text h-is-extra-text mt-1">{{ stakeRewardedPercentage }}%
                    of
                    total</p>
                <br/><br/>
