    ...
    <section class="section has-text-centered" style="min-height: 450px">
        <div class="is-flex is-justify-content-center">
            <div class="is-flex is-flex-direction-column is-align-items-start">
                ...
                >
                <router-link
                    :to="routeManager.makeRouteToTransactions()"
                    replace
                    id="dashboard-menu-item"
                    class="button is-ghost h-is-navbar-item h-is-mobile-navbar-item h-is-dense"
                    :class="{ 'is-rimmed': isTransactionRoute(previousRoute) }"
                    >Transactions</router-link
                >
                <router-link
                    :to="routeManager.makeRouteToTokens()"
                    replace
                    id="dashboard-menu-item"
                    class="button is-ghost h-is-navbar-item h-is-mobile-navbar-item h-is-dense"
                    :class="{ 'is-rimmed': isTokenRoute(previousRoute) }"
                    >Tokens</router-link
                >
                <router-link
                    :to="routeManager.makeRouteToTopics()"
                    replace
                    id="dashboard-menu-item"
                    class="button is-ghost h-is-navbar-item h-is-mobile-navbar-item h-is-dense"
                    :class="{ 'is-rimmed': isTopicRoute(previousRoute) }"
                    >Topics</router-link
                >
                <router-link
                    :to="routeManager.makeRouteToContracts()"
                    replace
                    id="dashboard-menu-item"
                    class="button is-ghost h-is-navbar-item h-is-mobile-navbar-item h-is-dense"
                    :class="{ 'is-rimmed': isContractRoute(previousRoute) }"
                    >Contracts</router-link
                >
                <router-link
                    :to="routeManager.makeRouteToAccounts()"
                    replace
                    id="dashboard-menu-item"
                    class="button is-ghost h-is-navbar-item h-is-mobile-navbar-item h-is-dense"
                    :class="{ 'is-rimmed': isAccountRoute(previousRoute) }"
                    >Accounts</router-link
                >
                <router-link
                    :to="routeManager.makeRouteToNodes()"
                    replace
                    id="dashboard-menu-item"
                    class="button is-ghost h-is-navbar-item h-is-mobile-navbar-item h-is-dense"
                    :class="{ 'is-rimmed': isNodeRoute(previousRoute) }"
                    >Nodes</router-link
                >
                <router-link
                ...
                >
                <router-link
                    :to="routeManager.makeRouteToBlocks()"
                    replace
                    id="dashboard-menu-item"
                    class="button is-ghost h-is-navbar-item h-is-mobile-navbar-item h-is-dense"
                    :class="{ 'is-rimmed': isBlocksRoute(previousRoute) }"
                    >Blocks</router-link
                >
            </div>
        </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        const isStakingEnabled =
            import.meta.env.VITE_APP_ENABLE_STAKING === "true";
