    ...
    <section :class="{'h-mobile-background': isTouchDevice || !isSmallScreen}" class="section">
        ...
        <DashboardCard>
            <template v-slot:title>
                ...
                <div v-if="!isMediumScreen && accountId" id="showAccountLink"
            ...
            <template v-slot:content>
                ...
                <template v-if="accountId">
                        ...
                        <div class="is-flex is-justify-content-space-between mt-5">
                            <div class="is-flex is-justify-content-flex-start">
                                <button id="stopStakingButton" class="button is-white is-small"
                                        :disabled="!stakedTo" @click="showStopConfirmDialog = true">STOP STAKING
                                </button>
                                <button id="showStakingDialog" class="button is-white is-small ml-4"
                                        @click="showStakingDialog = true">CHANGE STAKING
                                </button>
                            </div>
                            <button id="disconnectWalletButton" class="button is-white is-small"
                                    @click="disconnectFromWallet">DISCONNECT {{ walletName.toLocaleUpperCase() }}
                            </button>
                        </div>
                    ...
                    <div v-else>
                        <div class="is-flex-direction-column">
                            ...
                            <div class="mt-4"/>
                            <NetworkDashboardItem :name="stakedAmount ? 'HBAR' : ''" title="My Stake"
                                                  :value="stakedAmount"/>
                            <div class="mt-4"/>
                        ...
                        <div class="is-flex is-justify-content-center">
                            ...
                            <button id="showStakingDialogSmall" class="button is-white is-small ml-4"
                                    @click="showStakingDialog = true">CHANGE STAKED TO
                            </button>
                        </div>
                        <div class="is-flex is-justify-content-center mt-4">
                            <button id="disconnectWalletButtonSmall" class="button is-white is-small"
                                    @click="disconnectFromWallet">DISCONNECT WALLET
                            </button>
                        </div>
                        <div class="mt-5 h-is-text-size-2 is-italic has-text-grey has-text-centered">
                            <span class="has-text-grey-light">Please Note: </span>
                ...
                <template v-else-if="connecting">
                    <section class="section has-text-centered" style="min-height: 450px">
                        ...
                        <br/>
                        <button id="abortConnectWalletButton" class="button is-white is-small"
                                @click="disconnectFromWallet">ABORT CONNECTION
                        </button>
                    </section>
                </template>
                ...
                <template v-else>
                    <section class="section has-text-centered pt-0" :class="{'pb-0': isSmallScreen}">
                        ...
                        <br/>
                        <button id="connectWalletButton" class="button is-white is-small" @click="chooseWallet">CONNECT
                            WALLET…
                        </button>
                    </section>
                </template>
