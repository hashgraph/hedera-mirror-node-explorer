...
<template>
    <div :class="{ 'is-active': showDialog }" class="modal has-text-white">
        ...
        <div class="modal-content" style="width: 768px; border-radius: 16px">
            <div class="box">
                <div
                    class="is-flex h-is-primary-title is-justify-content-space-between is-align-items-baseline"
                >
                ...
                >
                    <div
                        v-if="mode === Mode.Success"
                        class="icon is-medium has-text-success ml-0"
                    >
                        <i class="fas fa-check" />
                    </div>
                    <div
                        v-else-if="mode === Mode.Error"
                    ...
                    <div
                        v-if="mainMessage"
                        class="block h-is-tertiary-text mt-2"
                    >
                        {{ mainMessage }}</div
                    >
                    <div
                        v-else
                        class="block h-is-tertiary-text"
                ...
                <div
                    class="is-flex is-align-items-baseline mt-4"
                    style="line-height: 21px"
                >
                    ...
                    <span
                        ...
                        >Filler</span
                    >
                    <div v-if="formattedTransactionId" class="ml-2">{{
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const formattedTransactionId = computed(() =>
            props.extraTransactionId != null
                ? TransactionID.normalize(props.extraTransactionId, true)
                : null,
        );
