                        ...
                        <div class="columns">
                            ...
                            <div class="column pt-0">
                                <div class="is-flex is-align-items-center">
                                    <input class="input is-small has-text-right has-text-white" type="text"
                ...
                <div class="columns">
                    ...
                    <div class="column pt-0">
                        <label class="checkbox">
                            <input checked="checked" type="checkbox" v-model="declineChoice"
                                   :disabled="!isNodeSelected || selectedNode == null">
                        </label>
                    </div>
                </div>
