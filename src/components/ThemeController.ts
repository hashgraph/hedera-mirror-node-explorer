...
export class ThemeController {
    ...
    private darkSelectedDidChange = () => {
        if (this.darkSelected.value) {
            ...
            document.documentElement.style.setProperty('--button-background-primary', 'var(--dark-button-background-primary)')
            ...
            document.documentElement.style.setProperty('--button-background-primary', 'var(--light-button-background-primary)')
