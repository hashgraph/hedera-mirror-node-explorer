...
<template>
    <div v-if="!isMediumScreen">
        <form
            ...
            class="control"
            action=""
            v-on:submit.prevent="performSearch"
        >
            <input
                    ...
                    try {
                        if (r.contract != null) {
                            ...
                            if (r.accountsWithKey.length >= 2) {
                                routeManager.routeToAccountsWithKey(
                                    r.searchedId,
                                );
                            } else {
                            ...
                            if (r.transactions.length == 1) {
                                ...
                                routeManager.routeToTransactionsById(
                            ...
                            routeManager.routeToNoSearchResult(
                                searchedId.value,
                                r.getErrorCount(),
                            );
                            searchDidEnd(false);
