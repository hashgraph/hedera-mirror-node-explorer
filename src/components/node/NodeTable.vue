    ...
    <div v-if="nodes" id="node-table">
        ...
        >
            <o-table-column v-slot="props" field="nature" label="">
                <span
                    class="icon has-text-info regular-node-column"
                    style="font-size: 16px"
                >
                    <i
                        v-if="isCouncilNode(props.row)"
            ...
            >
                <div class="should-wrap regular-node-column is-inline-block">
                    ...
                    />
                    <StringValue
                        :string-value="makeNodeOwnerDescription(props.row)"
                    />
                </div>
            </o-table-column>
            ...
            >
                ...
                >
                    <div class="regular-node-column">
                        <StringValue
                            :string-value="makeWeightPercentage(props.row)"
                        />
                    </div>
                </o-tooltip>
            </o-table-column>
                ...
                <o-tooltip :delay="tooltipDelay" class="h-tooltip">
                    ...
                    <template #content>
                        <div class="reward-range-tooltip">
                            <div
                                class="caption has-background-success has-text-right"
                            ></div>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const makeWeightPercentage = (node: NetworkNode) => {
            return node.stake && props.stakeTotal
                ? makeStakePercentage(node, props.stakeTotal)
                : "0";
        };
