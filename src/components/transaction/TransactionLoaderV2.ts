...
export class TransactionLoaderV2 extends EntityLoader<Transaction> {
    ...
    protected async load(): Promise<AxiosResponse<Transaction>|null> {
        ...
        const tth = tloc instanceof EthereumHash ? await TransactionLoaderV2.findTimestampForEthereumHash(tloc) : tloc
        ...
        if (tth !== null) {
            ...
            if (this.transactionId.value !== null) { // We have the transaction id  :)
                ...
                transactionId = await TransactionLoaderV2.findTransactionId(tth)
            }
            ...
            if (transactionId !== null) {
                ...
                transaction = TransactionLoaderV2.lookupTransaction(this.transactionsRef.value, tth)
            } else {
                this.transactionsRef.value = []
                transaction = null
            }
