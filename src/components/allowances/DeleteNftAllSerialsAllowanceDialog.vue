...
export default defineComponent({
  name: "DeleteNftAllSerialsAllowanceDialog",
  ...
  setup(props) {
    const spender = computed(() => props.nftAllSerialsAllowance?.spender ?? null)
    const token = computed(() => props.nftAllSerialsAllowance?.token_id ?? null)
    ...
    const onDelete = async () => {
      ...
      if (token.value != null && spender.value != null) {
        let tid = null
