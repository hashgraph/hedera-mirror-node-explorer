...
<template v-if="change">
    <template v-if="change?.header === true">
        <div class="is-flex is-align-items-baseline">
            <ContractLink
                :contract-id="change?.changes.contract_id"
            ></ContractLink>
            <EVMAddress
    ...
    <div class="columns" style="margin-bottom: 0">
        ...
        <div class="column py-1">
            <HexaValue
                ...
                :word-wrap-medium="8"
                :show-none="true"
                :low-contrast="change?.valueReadDecimal === 0"
            />
            <div class="h-is-extra-text h-is-text-size-2">
                {{
        ...
        <div class="column py-1">
            <HexaValue
                ...
                :word-wrap-medium="8"
                :show-none="true"
                :low-contrast="change?.valueWrittenDecimal === 0"
            />
            <div class="h-is-extra-text h-is-text-size-2">
                <span v-if="change?.changes.value_written">
                    {{
                        "Decimal: " +
                        (change?.valueWrittenDecimal ?? "not available")
                    }}
                </span>
