        ...
        <DashboardCard class="h-card">
            <template v-slot:title>
                <span v-if="topLevel" class="h-is-primary-title">
                    Contract Result for {{ contractResult?.contract_id }} at
            ...
            <template v-slot:leftContent>
                ...
                <Property id="evm-hash">
                    ...
                    <template v-slot:value>
                        <HexaValue
                            v-bind:byteString="contractResult?.hash"
            ...
            <template v-slot:rightContent>
                ...
                <Property id="gasLimit">
                    ...
                    <template v-slot:value>
                        <PlainAmount
                            :amount="contractResult?.gas_limit"
                            none-label="None"
                        />
                    </template>
                </Property>
                <Property id="gasUsed">
                    ...
                    <template v-slot:value>
                        <PlainAmount
                            :amount="contractResult?.gas_used"
                            none-label="None"
                        />
                    </template>
                </Property>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const contractResultAnalyzer = new ContractResultAnalyzer(
        ...
        return {
            ...
            functionHash:
                contractResultAnalyzer.functionCallAnalyzer.functionHash,
