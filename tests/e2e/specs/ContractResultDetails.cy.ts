...
describe("ContractResultDetails", () => {
    it("should display contract result of contract call transaction", () => {
        ...
        cy.get("#fromValue").should(
            "have.text",
            "0x00000000000000000000000000000000000cf475Copy(0.0.849013)",
        );
        cy.get("#toValue").should(
            "have.text",
            "0x0000000000000000000000000000000000121951Copy(0.0.1186129)",
        );
    });
    ...
    it("should display contract result of child (contract call) transaction", () => {
        ...
        cy.get("#fromValue").should(
            "have.text",
            "0xb6d4c5a61a0c104b6c9222630fac403178725f7fCopy(0.0.1463739)",
        );
        cy.get("#toValue").should(
            "have.text",
            "0x0000000000000000000000000000000000000167Copy(Hedera Token Service System Contract)",
        );
    });
    ...
    it("should display contract result of child (token burn) transaction", () => {
        ...
        cy.get("#fromValue").should(
            "have.text",
            "0x0000000000000000000000000000000000163b59Copy(0.0.1456985)",
        );
        cy.get("#toValue").should(
            "have.text",
            "0x0000000000000000000000000000000000000167Copy(Hedera Token Service System Contract)",
