...
describe("Search Bar", () => {
    ...
    it("should find and list the scheduling/scheduled transactions", () => {
        ...
        testBody(
            ...
            "/mainnet/transactionsById/" +
                normalizeTransactionId(searchTransaction),
    ...
    it("should find the transaction by hash", () => {
        cy.visit("/mainnet/dashboard");
        const searchHash =
            "0x08e62c0531e603fa6d29930195682e937978d542bd404d490546717bb128da4ec4ed586e6d516735f24049b2c3eb7b20";
    ...
    it("should find the account by public key", () => {
        cy.visit("/mainnet/dashboard");
        const searchKey =
            "0x02e783457e4d054db3c7850c2dc83e458a13b210fca75984bc7cfb0fae7343ff60";
    ...
    it("should find the account by public-key-format alias", () => {
        const searchBase32Alias =
            "CIQAAAH4AY2OFK2FL37TSPYEQGPPUJRP4XTKWHD62HKPQX543DTOFFQ";
        const searchHexaAlias =
...
const testBody = (
    ...
    if (expectTable) {
        cy.get("table").find("tbody tr").should("have.length.gt", 1);
