...
describe("MainDashboard.vue", () => {
    ...
    test("no props", async () => {
        ...
        expect(cards[0].findComponent(PlayPauseButtonV3).exists()).toBe(true)
        ...
        expect(cards[1].findComponent(PlayPauseButtonV3).exists()).toBe(true)
        ...
        expect(cards[2].findComponent(PlayPauseButtonV3).exists()).toBe(true)
