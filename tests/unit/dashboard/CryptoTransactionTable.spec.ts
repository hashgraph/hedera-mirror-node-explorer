...
describe("CryptoTransactionTable.vue", () => {
    ...
    test("no accountIdFilter", async () => {
        ...
        mock.onGet(matcher).reply(200, SAMPLE_CRYPTO_TRANSACTIONS)
        ...
        expect(wrapper.find('tbody').text()).toBe(
            "0.0.14622@1646746046.722961649 0.0.14622\n\n" +
            "0.00090000\n\n" +
            "0.0.146840.0.14698\n\n\n\n" +
            "1:27:39.5585 PMMar 8, 20220.0.19852@1646746046.457048377 0.0.14698\n\n" +
            "0.00090000\n\n" +
            "0.0.146840.0.19852\n\n\n\n" +
            "1:27:39.0402 PMMar 8, 2022"
        )
    });
