...
describe("HbarMarketDashboard.vue ", () => {
    it("should display the market dashboard banner", async () => {
        ...
        expect(
            wrapper.vm.marketDataCache.hbarPriceCache.autoRefresh.value,
        ).toBe(true);
        expect(
            wrapper.vm.marketDataCache.hbarPrice24hCache.autoRefresh.value,
        ).toBe(true);
        expect(
            wrapper.vm.marketDataCache.hbarSupplyCache.autoRefresh.value,
        ).toBe(true);
        expect(
            wrapper.vm.marketDataCache.hbarSupply24hCache.autoRefresh.value,
        ).toBe(true);
