...
describe("ContractResultByTransactionIdCache", () => {
    test("ContractResultByTransactionIdCache", async () => {
        expect(
            ContractResultByTransactionIdCache.instance.isEmpty(),
        ).toBeTruthy();
        ...
        const contractResult =
            await ContractResultByTransactionIdCache.instance.lookup(
                transactionId,
            );
        ...
        expect(
            ContractResultByTransactionIdCache.instance.contains(transactionId),
        );
    });
});
