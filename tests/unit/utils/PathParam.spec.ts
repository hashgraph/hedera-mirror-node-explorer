...
describe("PathParam", () => {
    ...
    test("PathParam.parseBlockHashOrNumber() with a hash", () => {
        const sampleHash =
            "aa1c941f33e06fc8458bf82880527b01473ca7dff9dee0159542c00971038109dbd86515ff4ff1f4d9fd25428d39489b";
    ...
    test("PathParam.parseBlockHashOrNumber() with invalid block hash", () => {
        const tooShort =
            "1c941f33e06fc8458bf82880527b01473ca7dff9dee0159542c00971038109dbd86515ff4ff1f4d9fd25428d39489b";
        ...
        const tooLong =
            "aa1c941f33e06fc8458bf82880527b01473ca7dff9dee0159542c00971038109dbd86515ff4ff1f4d9fd25428d39489b00";
    ...
    test("PathParam.parseAccountLoc() with alias in base32", () => {
        const alias =
            "HIQQGOSRIF3EM35ICXWUQH722CIRBIWTIT3MTN4MDUKK7Q2RYOSRXYZ5";
    ...
    test("PathParam.parseAccountLoc() with alias in hex", () => {
        const alias =
            "HIQQGOSRIF3EM35ICXWUQH722CIRBIWTIT3MTN4MDUKK7Q2RYOSRXYZ5";
        const aliasInHex =
            "0x3a21033a514176466fa815ed481ffad09110a2d344f6c9b78c1d14afc351c3a51be33d";
