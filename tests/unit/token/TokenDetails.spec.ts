...
describe("TokenDetails.vue", () => {
    it("Should display details of fungible token", async () => {
        ...
        expect(wrapper.get("#autoRenewAccountValue").text()).toBe(
            "0.0.29612329",
        );
        expect(wrapper.get("#freezeDefaultValue").text()).toBe("false");
        expect(wrapper.get("#pauseStatusValue").text()).toBe("Not applicable");

        expect(wrapper.get("#treasuryAccountValue").text()).toBe(
            "0.0.29624024",
        );
        expect(wrapper.get("#createdAtValue").text()).toBe(
            "10:02:30.2333 AMFeb 12, 2022, UTC",
        );
        expect(wrapper.get("#modifiedAtValue").text()).toBe(
            "10:02:30.2333 AMFeb 12, 2022, UTC",
        );
        ...
        expect(wrapper.get("#evmAddress").text()).toMatch(
            RegExp(
                "^EVM Address:0x0000000000000000000000000000000001c49eecCopy",
            ),
        );
        ...
        expect(wrapper.vm.tokenBalanceTableController.mounted.value).toBe(
            false,
        );
    ...
    it("Should detect invalid token ID", async () => {
        ...
        expect(wrapper.get("#notificationBanner").text()).toBe(
            "Invalid token ID: " + invalidTokenId,
        );
    ...
    it("Should display all token keys", async () => {
        ...
        expect(wrapper.find("#adminKey").text()).toBe(
            "Admin Keyc539 536f 9599 daef eeb7 7767 7aa1 aeea 2242 dfc7 cca9 2348 c228 a518 7a0f af2bCopyED25519",
        );
        expect(wrapper.find("#kycKey").text()).toBe(
            "KYC Keyc539 536f 9599 daef eeb7 7767 7aa1 aeea 2242 dfc7 cca9 2348 c228 a518 7a0f af2bCopyED25519",
        );
        expect(wrapper.find("#freezeKey").text()).toBe(
            "Freeze Keyc539 536f 9599 daef eeb7 7767 7aa1 aeea 2242 dfc7 cca9 2348 c228 a518 7a0f af2bCopyED25519",
        );
        expect(wrapper.find("#wipeKey").text()).toBe(
            "Wipe Keyc539 536f 9599 daef eeb7 7767 7aa1 aeea 2242 dfc7 cca9 2348 c228 a518 7a0f af2bCopyED25519",
        );
        expect(wrapper.find("#supplyKey").text()).toBe(
            "Supply Keyc539 536f 9599 daef eeb7 7767 7aa1 aeea 2242 dfc7 cca9 2348 c228 a518 7a0f af2bCopyED25519",
        );
        expect(wrapper.find("#feeScheduleKey").text()).toBe(
            "Fee Schedule Keyc539 536f 9599 daef eeb7 7767 7aa1 aeea 2242 dfc7 cca9 2348 c228 a518 7a0f af2bCopyED25519",
        );
        expect(wrapper.find("#pauseKey").text()).toBe(
            "Pause Keyc539 536f 9599 daef eeb7 7767 7aa1 aeea 2242 dfc7 cca9 2348 c228 a518 7a0f af2bCopyED25519",
        );
    ...
    it("Should display no token keys", async () => {
        ...
        expect(wrapper.find("#kycKey").text()).toBe(
            "KYC KeyNoneKYC is not required",
        );
        expect(wrapper.find("#freezeKey").text()).toBe(
            "Freeze KeyNoneToken cannot be frozen",
        );
        expect(wrapper.find("#wipeKey").text()).toBe(
            "Wipe KeyNoneToken cannot be wiped",
        );
        expect(wrapper.find("#supplyKey").text()).toBe(
            "Supply KeyNoneToken cannot be minted or burnt",
        );
        expect(wrapper.find("#feeScheduleKey").text()).toBe(
            "Fee Schedule KeyNoneCustom fee schedule is immutable",
        );
        expect(wrapper.find("#pauseKey").text()).toBe(
            "Pause KeyNoneToken cannot be paused",
        );
    ...
    it("Should display 'Token deleted' banner", async () => {
        ...
        const testTokenEVMAddress =
            "0x0000000000000000000000000000000000016739";
        const matcher1 = "/api/v1/tokens/" + testTokenId;
        mock.onGet(matcher1).reply(200, SAMPLE_TOKEN_WITHOUT_KEYS);
        const matcher2 = "/api/v1/tokens/" + testTokenId + "/nfts";
        mock.onGet(matcher2).reply(200, SAMPLE_NFTS);
    ...
    it("Should display fixed fees and fractional fee of token", async () => {
        ...
        expect(fixedFee.get("thead").text()).toBe(
            "Fixed Fee Fee Currency Collector Account",
        );
        ...
        expect(fractionalFee.get("thead").text()).toBe(
            "Fractional Fee Fee Currency Collector Account Min Max Net",
        );
    ...
    it("Should display fixed fees and royaltee fee of token", async () => {
        ...
        expect(customFees.findComponent(FractionalFeeTable).exists()).toBe(
            false,
        );

        const royalteeFee = customFees.findComponent(RoyaltyFeeTable);
        expect(royalteeFee.exists()).toBe(true);
        expect(royalteeFee.get("thead").text()).toBe(
            "Percentage Fee Collector Account Fallback Fee Fee Currency",
        );
