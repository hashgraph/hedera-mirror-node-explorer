...
describe("TokenDetails.vue", () => {
    ...
    it("Should display details of fungible token", async () => {
        ...
        expect(wrapper.get("#ethereumAddressValue").text()).toBe("0000 0000 0000 0000 0000 0000 0000 0000 01c4 9eecCopy to ClipboardImport in Metamask…Please install MetaMask! To watch this asset with MetaMask, you must download and install MetaMask extension for your browser.")
