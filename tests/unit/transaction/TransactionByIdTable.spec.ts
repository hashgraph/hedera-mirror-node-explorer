    ...
    it("Should list transactions as parent and child", async () => {
        ...
        const wrapper = mount(TransactionByIdTable, {
            ...
            props: {
                ...
                nbItems: 42,
                transactions:
                    SAMPLE_PARENT_CHILD_TRANSACTIONS.transactions as Array<Transaction>,
            },
        });
        ...
        expect(wrapper.find("thead").text()).toBe(
            "Time Type Content Relationship Nonce",
        );
    ...
    it("Should list transactions as scheduling and scheduled", async () => {
        ...
        const wrapper = mount(TransactionByIdTable, {
            ...
            props: {
                ...
                nbItems: 42,
                transactions:
                    SAMPLE_SCHEDULING_SCHEDULED_TRANSACTIONS.transactions as Array<Transaction>,
            },
        });
    ...
    it("Should list transactions as unrelated", async () => {
        ...
        const wrapper = mount(TransactionByIdTable, {
            ...
            props: {
                ...
                nbItems: 42,
                transactions:
                    SAMPLE_SAME_ID_NOT_PARENT_TRANSACTIONS.transactions as Array<Transaction>,
            },
        });
